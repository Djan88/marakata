               ...
               <section class="section section--menu" id="Adrian">
                 <nav class="menu menu--adrian">
                   <ul class="menu__list">
                     ...
                     <li class="menu__item"><a href="/wp-login.php?action=logout&_wpnonce=70d68623f4" class="menu__link menu-logout"><span class="menu__helper menu-logout">ВЫХОД</span></a></li>
                   </ul>
                 </nav>
               </section>
             </div>
