						...
						<div class="row">
							<div class="col-xs-offset-0 col-sm-12">
								...
								<p class="lead"
									...
									data-out-animation="fadeOutUp"
									data-out-animation-delay="300">
									<p>Комплект состоит из органических носителей флюида стабилизированных золотом, рабочих полей -  утилизатора и усилителя, а также нейрофизиологического оцифратора дисфункций, работающего на принципах феномена Р300.
									Возможны три режима работы:</p>
									<p>
									...
									<p>
									Больше о проекте "Marakata" Вы можете узнать из одноименной главы в книге Юрия Чикурова "Биологическое Центрирование".</p>
									<div class="row"
										data-animation="fadeInDown"
