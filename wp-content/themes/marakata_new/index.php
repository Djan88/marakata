						...
						<div class="row">
							<div class="col-xs-offset-0 col-sm-12">
								...
								<p class="lead"
									...
									data-out-animation="fadeOutUp"
									data-out-animation-delay="300">
									<p>Комплект состоит из органических носителей флюида стабилизированных золотом, рабочих полей -  <i>утилизатора</i> и <i>усилителя</i>, а также <i>нейрофизиологического оцифратора дисфункций</i>, работающего на принципах феномена Р300.
									...
									<p>
									Технология Мараката может использоваться как самостоятельно, в рамках практической психосоматики, так и в сочетании с другими телесно ориентированными методами работы с клиентом, включая остеопатию, краниосакральную терапию, биодинамику, прикладную кинезиологию и прочая.</p>
									<p>
									Больше о проекте "Marakata" Вы можете узнать из одноименной главы в книге Юрия Чикурова <a target="_blank" href="https://chikurov.com/kniga/">"Биологическое Центрирование"</a>.</p>
									<div class="row"
										data-animation="fadeInDown"
