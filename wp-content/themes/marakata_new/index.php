			...
			<div class="section-content">
				<div class="container">
					<div class="contact-wrap relative">
						<div class="row">
							<div class="col-xs-offset-0 col-sm-10 col-sm-offset-1 col-md-10 col-md-offset-1">
								<h2 class="text-center section-title"
									data-animation="fadeInDown"
								...
								<p class="lead"
									...
									<img src="<?php bloginfo('template_url'); ?>/img/98png" alt="field">
									<img src="<?php bloginfo('template_url'); ?>/img/99png" alt="icons">
								</p>
