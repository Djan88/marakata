						...
						<div class="row section-description">
							<div class="col-sm-12">
								...
								<p class="lead"
									...
									data-out-animation="fadeOutUp"
									data-out-animation-delay="300">
									Данный проект представляет собой цифровую составляющую проектов "MARAKATA" и "ДЕВЯТОЧКА".
									Пользователям доступны два нейрофизиологических оцифратора дисфункций, работающих на принципах феномена Р300. Каждый из них предназначен для конкретного проекта и не может быть заменен другим.
								</p>
							</div>
						</div>
						<?php if(!is_user_logged_in()){ ?>
						...
						<div class="row">
							<div class="col-xs-offset-0 col-sm-12">
								...
								<p class="lead"
									...
									data-out-animation="fadeOutUp"
									data-out-animation-delay="300">
									Комплект состоит из органических носителей флюида стабилизированных золотом, рабочих полей -  утилизатора и усилителя, а также нейрофизиологического оцифратора дисфункций, работающего на принципах феномена Р300.<br>
